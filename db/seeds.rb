...
# APPLICATIONS
app1 = Application.create(user_id: hannah.id, job_listing_id: listing1.id, status: "applied")
...
app7 = Application.create(user_id: senada.id, job_listing_id: listing1.id, status: "applied")
