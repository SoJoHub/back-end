...
Interview.create(application_id: app3.id, user_id: hannah.id, date: DateTime.now, complete: true, interviewer: "Jack", location: "NYC", notes: "it went horribly :(")
Interview.create(application_id: app9.id, user_id: senada.id, date: DateTime.now, complete: true, interviewer: "Bashir", location: "NYC", notes: "i killed it")
